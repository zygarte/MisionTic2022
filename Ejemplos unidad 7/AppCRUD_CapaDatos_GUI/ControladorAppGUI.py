...
import InterfazGUI as iGUI #Interfaz gráfica para interacción con el usuario UI
...
############################################################################################
#->Observar que:
# Al tener las dos alternativas de vistas, basta con activar cualquiera de los dos mainloops
# para tener modo consola o modo GUI.
############################################################################################
