...
def circuloSinRelleno(tortuga):
    tortuga.goto(0,0)
    tortuga.speed(1)
    tortuga.circle(100)

def estrellaCincoPuntasColores(tortuga):
    # decide colors
...
tortuga.setup(800,600,0,0)#Ver del área de trabajo
...
while mainloop:
    ...
    #Si la opcíon de salida fue seleccionadA por el usuario en el menú    
        ...
        #Reportar en consola procedimiento del objeto
        mensaje("->Dibujando circulo sin Relleno")       

        #Procedimiento ralizando cambios de estado en el objeto        
        tortuga.clear()
        circuloSinRelleno(tortuga)#Crear un circulo paso a paso

    #Si Dibujado de circulo fue seleccionado
    elif opcion == 7:
        
        #Reportar en consola procedimiento del objeto
        mensaje("->Dibujando estrella 5 puntas lineas de colores")       

        #Procedimiento ralizando cambios de estado en el objeto        
        tortuga.clear()
        estrellaCincoPuntasColores(tortuga)#Crear un circulo paso a paso
